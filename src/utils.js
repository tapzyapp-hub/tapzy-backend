...
function renderTapzyAssistant(options = {}) {
  ...
  .tz-ai-orb{position:absolute;left:50%;top:44%;width:min(76vw,420px);aspect-ratio:1/1;transform:translate(-50%,-50%);display:grid;place-items:center;filter:drop-shadow(0 34px 80px rgba(0,0,0,.72));animation:tzAiFloat 6.4s ease-in-out infinite;z-index:2;isolation:isolate;}
  .tz-ai-orb::before{content:"";position:absolute;inset:0;border-radius:50%;background:radial-gradient(circle,rgba(83,163,255,.28),rgba(8,18,34,.36) 45%,transparent 68%);box-shadow:0 0 56px rgba(48,129,255,.45),0 0 120px rgba(48,129,255,.22);animation:tzAiGlow 4.8s ease-in-out infinite;z-index:0;}
  .tz-ai-orb::after{content:"";position:absolute;inset:0;border-radius:50%;border:1px solid rgba(147,213,255,.24);box-shadow:inset 0 0 42px rgba(96,171,255,.12),0 0 28px rgba(68,148,255,.24);animation:tzAiRing 8s linear infinite;z-index:3;}
  .tz-ai-face{position:relative;width:100%;aspect-ratio:1/1;border-radius:50%;overflow:hidden;background:radial-gradient(circle at 50% 48%,rgba(210,230,255,.08),rgba(0,0,0,.08) 48%,transparent 70%);transform:perspective(900px) rotateX(0deg) rotateY(-4deg);animation:tzAiFaceBreathe 5.4s ease-in-out infinite;box-shadow:inset 0 0 0 1px rgba(255,255,255,.07),inset 0 0 42px rgba(65,144,255,.12),0 0 52px rgba(206,230,255,.17);z-index:2;}
  .tz-ai-face img{position:absolute;left:50%;top:50%;width:142%;height:142%;transform:translate(-50%,-50%) scale(1.08);object-fit:cover;opacity:.96;filter:grayscale(1) brightness(1.2) contrast(1.22);mix-blend-mode:screen;}
  .tz-ai-face::before{content:"";position:absolute;inset:0;background:linear-gradient(rgba(255,255,255,.12) 1px,transparent 1px),linear-gradient(90deg,rgba(255,255,255,.1) 1px,transparent 1px),radial-gradient(circle at 45% 46%,transparent 0 43%,rgba(0,0,0,.58) 72%,rgba(0,0,0,.84) 100%);background-size:8px 8px,8px 8px,100% 100%;opacity:.28;animation:tzAiPixelDrift 8s linear infinite;}
  .tz-ai-face::after{content:"";position:absolute;left:62%;top:67%;width:19%;height:8%;border-radius:50%;background:rgba(0,0,0,.84);box-shadow:0 0 18px rgba(255,255,255,.2),inset 0 0 12px rgba(255,255,255,.16);transform:translate(-50%,-50%) scaleY(.42);animation:tzAiMouthIdle 4.2s ease-in-out infinite;}
  .tz-ai-eye{position:absolute;width:8%;height:3%;border-radius:999px;background:rgba(6,8,12,.86);box-shadow:0 0 14px rgba(255,255,255,.16);z-index:3;animation:tzAiBlink 7s ease-in-out infinite;}.tz-ai-eye.left{left:51%;top:42%;transform:rotate(-8deg)}.tz-ai-eye.right{left:70%;top:40%;transform:rotate(10deg)}
  .tz-ai-waveform{position:absolute;left:50%;top:50%;width:104%;height:104%;transform:translate(-50%,-50%);border-radius:50%;border:1px solid rgba(108,184,255,.18);opacity:0;z-index:1;pointer-events:none;}.tz-ai-waveform span{position:absolute;left:50%;top:50%;width:8px;height:34px;border-radius:999px;background:linear-gradient(#8fd3ff,#256fff);transform-origin:50% 145px;opacity:.58;animation:tzAiWaveBars 1.2s ease-in-out infinite}.tz-ai-waveform span:nth-child(1){transform:translate(-50%,-50%) rotate(0deg);animation-delay:0ms}.tz-ai-waveform span:nth-child(2){transform:translate(-50%,-50%) rotate(36deg);animation-delay:80ms}.tz-ai-waveform span:nth-child(3){transform:translate(-50%,-50%) rotate(72deg);animation-delay:160ms}.tz-ai-waveform span:nth-child(4){transform:translate(-50%,-50%) rotate(108deg);animation-delay:240ms}.tz-ai-waveform span:nth-child(5){transform:translate(-50%,-50%) rotate(144deg);animation-delay:320ms}.tz-ai-waveform span:nth-child(6){transform:translate(-50%,-50%) rotate(180deg);animation-delay:400ms}.tz-ai-waveform span:nth-child(7){transform:translate(-50%,-50%) rotate(216deg);animation-delay:480ms}.tz-ai-waveform span:nth-child(8){transform:translate(-50%,-50%) rotate(252deg);animation-delay:560ms}.tz-ai-waveform span:nth-child(9){transform:translate(-50%,-50%) rotate(288deg);animation-delay:640ms}.tz-ai-waveform span:nth-child(10){transform:translate(-50%,-50%) rotate(324deg);animation-delay:720ms}
  ...
  .tz-ai-room .tz-ai-body{position:relative;z-index:4;max-height:23vh!important;padding:0 14px 8px!important;}.tz-ai-room .tz-ai-prompts{position:relative;z-index:4;padding:0 14px 8px!important}.tz-ai-room .tz-ai-form{position:relative;z-index:4;margin:0 12px;border:1px solid rgba(255,255,255,.1)!important;border-radius:22px!important;background:rgba(9,16,28,.64)!important;box-shadow:0 18px 44px rgba(0,0,0,.38);backdrop-filter:blur(18px);-webkit-backdrop-filter:blur(18px)}.tz-ai-room .tz-ai-status{position:relative;z-index:4;padding:6px 16px calc(12px + env(safe-area-inset-bottom))!important;}
