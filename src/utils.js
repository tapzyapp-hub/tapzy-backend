...
(function(){
  ...
  roots.forEach(function(root){
    ...
    var memory=[],geo=null,geoAsked=false,busy=false,stateTimer=null,pillTimer=null,hiddenTapCount=0,browserTimeZone=(function(){try{return Intl.DateTimeFormat().resolvedOptions().timeZone||'';}catch(_){return '';}})();
