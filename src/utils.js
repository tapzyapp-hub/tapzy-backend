...
<style data-tapzy-assistant>
  ...
  .tz-ai-body{position:absolute;left:14px;right:14px;bottom:12px;z-index:6;display:flex;flex-direction:column;gap:10px;width:auto;max-height:44%;min-height:0;overflow:auto;padding:0;box-sizing:border-box;scrollbar-width:none}.tz-ai-body::-webkit-scrollbar{display:none}
  .tz-ai-msg{max-width:88%;min-width:0;margin:0;padding:13px 15px;border-radius:20px;font-size:14px;line-height:1.46;white-space:pre-wrap;overflow-wrap:anywhere;word-break:normal;background:linear-gradient(180deg,rgba(17,22,34,.86),rgba(10,15,25,.78));border:1px solid rgba(157,193,255,.18);box-shadow:0 18px 42px rgba(0,0,0,.34),inset 0 1px 0 rgba(255,255,255,.08);backdrop-filter:blur(18px);-webkit-backdrop-filter:blur(18px)}.tz-ai-msg.bot{align-self:flex-start;width:100%;max-width:100%;color:rgba(255,255,255,.95);border-radius:22px}.tz-ai-msg.user{align-self:flex-end;width:auto;max-width:78%;background:linear-gradient(145deg,#2f7bff,#1559e6);border-color:rgba(150,205,255,.24);color:#fff;box-shadow:0 14px 32px rgba(35,105,255,.26)}
