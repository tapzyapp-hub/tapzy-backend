...
function renderTapzyAssistant(options = {}) {
  ...
  .tz-ai-orb{position:absolute;left:50%;top:42%;width:min(70vw,350px);aspect-ratio:1/1;transform:translate(-50%,-50%);display:grid;place-items:center;filter:drop-shadow(0 30px 76px rgba(0,0,0,.72));animation:tzAiFloat 6.4s ease-in-out infinite;z-index:2;isolation:isolate;}
  ...
  .tz-ai-room .tz-ai-prompts{z-index:6!important;}
  .tz-ai-room .tz-ai-form{z-index:7!important;}
  @media(max-width:520px){.tz-ai-room .tz-ai-body{max-height:180px!important;min-height:122px!important}.tz-ai-room .tz-ai-msg.bot{max-height:166px!important;font-size:13px!important;line-height:1.38!important}}
