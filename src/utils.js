...
function renderTapzyAssistant(options = {}) {
  ...
  .tz-ai-room .tz-ai-link-chip{display:inline-flex;align-items:center;max-width:100%;min-height:25px;margin:2px 4px 2px 0;padding:4px 9px;border-radius:999px;border:1px solid rgba(112,178,255,.28);background:rgba(45,119,255,.16);color:#dcecff!important;text-decoration:none!important;font-size:11px!important;line-height:1!important;font-weight:900;vertical-align:baseline;box-shadow:inset 0 1px 0 rgba(255,255,255,.08),0 6px 18px rgba(30,96,220,.18);}
  .tz-ai-room .tz-ai-link-chip:active{transform:scale(.97);}
