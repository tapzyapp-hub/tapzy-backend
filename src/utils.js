...
<style data-tapzy-assistant>
  ...
  .tz-ai-msg{max-width:88%;min-width:0;margin:0;padding:14px 16px;border-radius:22px;font:500 13.5px/1.54 Inter,"SF Pro Text","Segoe UI",system-ui,sans-serif;letter-spacing:0;white-space:pre-wrap;overflow-wrap:anywhere;word-break:normal;background:linear-gradient(180deg,rgba(18,24,38,.9),rgba(9,14,24,.82));border:1px solid rgba(166,205,255,.2);box-shadow:0 18px 42px rgba(0,0,0,.34),inset 0 1px 0 rgba(255,255,255,.09),inset 0 -18px 44px rgba(44,105,190,.05);text-shadow:0 1px 16px rgba(156,206,255,.08);backdrop-filter:blur(18px);-webkit-backdrop-filter:blur(18px);-webkit-font-smoothing:antialiased;text-rendering:optimizeLegibility}.tz-ai-msg.bot{align-self:flex-start;width:100%;max-width:100%;color:rgba(245,249,255,.96);border-radius:22px}.tz-ai-msg.user{align-self:flex-end;width:auto;max-width:78%;font-weight:650;line-height:1.42;background:linear-gradient(145deg,#2f7bff,#1559e6);border-color:rgba(150,205,255,.24);color:#fff;box-shadow:0 14px 32px rgba(35,105,255,.26)}
