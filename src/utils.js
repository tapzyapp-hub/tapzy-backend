...
<style data-tapzy-assistant>
  ...
  .tz-ai-prompts{position:relative;z-index:4;display:flex;align-items:center;height:38px;padding:0 22px 6px;gap:10px;overflow-x:auto;overflow-y:hidden;scrollbar-width:none}.tz-ai-prompts::-webkit-scrollbar{display:none}.tz-ai-chip{display:inline-flex;align-items:center;justify-content:center;min-height:32px;padding:0 14px;border-radius:999px;font-size:10px;font-weight:900;letter-spacing:1px;text-transform:uppercase;background:rgba(10,18,34,.58);border:1px solid rgba(156,214,255,.22);color:#eef7ff;white-space:nowrap;cursor:pointer}
  ...
  @media(max-width:520px){.tz-ai-head{padding:calc(14px + env(safe-area-inset-top)) 20px 12px}.tz-ai-room-card{width:calc(100vw - 24px);height:min(56vh,500px);min-height:350px;border-radius:30px}.tz-ai-orb{width:min(42vw,160px);top:39%}.tz-ai-body{left:10px;right:10px;bottom:10px;max-height:40%}.tz-ai-form{margin-left:18px;margin-right:18px}.tz-ai-status{padding-bottom:calc(82px + env(safe-area-inset-bottom))}}
</style>
<div class="tz-ai-root" data-tapzy-assistant data-username="__USERNAME__" data-page-type="__PAGETYPE__" data-auth-page="__ISAUTH__">
  ...
  <section class="tz-ai-panel" aria-label="Ask Tapzy assistant" role="dialog" aria-modal="false">
    ...
    <main class="tz-ai-stage"><div class="tz-ai-room-card"><div class="tz-ai-orb" aria-hidden="true"><div class="tz-ai-face"><img src="/images/tapzy-identity-digital-face.jpg" alt=""/></div></div><div class="tz-ai-state"><div class="tz-ai-state-pill"><span class="tz-ai-state-dot"></span><span class="tz-ai-state-text">Idle</span></div></div><div class="tz-ai-body"><div class="tz-ai-msg bot">Ask me anything. We can have a real conversation, search the web, talk Tapzy, find places, plan your night, check weather, or get directions.</div></div></div></main>
