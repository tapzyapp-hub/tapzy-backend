...
function renderCleanStyles() {
  return [
    ...
    ".premium-events-top{max-width:960px;margin:0 auto 10px;display:flex;align-items:center;gap:13px;padding:13px 14px;border:1px solid rgba(116,198,255,.18);border-radius:24px;background:linear-gradient(180deg,rgba(8,13,22,.96),rgba(0,0,0,.96));box-shadow:0 20px 64px rgba(0,0,0,.48),inset 0 1px 0 rgba(255,255,255,.065);backdrop-filter:blur(24px);-webkit-backdrop-filter:blur(24px);}",
    ".premium-events-mark{width:50px;height:50px;border:1px solid rgba(255,255,255,.18);border-radius:17px;display:grid;place-items:center;background:linear-gradient(145deg,var(--tz-blue),var(--tz-blue-2));box-shadow:0 0 28px rgba(47,123,255,.42),0 14px 38px rgba(0,0,0,.46),inset 0 1px 0 rgba(255,255,255,.25);cursor:pointer;flex:0 0 auto;}",
    ...
    ".premium-events-top h1{margin:0;font-size:clamp(25px,6vw,36px);line-height:.96;font-weight:950;letter-spacing:0;color:#fff;text-shadow:0 0 28px rgba(62,142,255,.18);}",
    ...
    "@media(max-width:720px){.clean-events-page{padding-left:16px;padding-right:16px}.premium-events-top{margin-bottom:10px;border-radius:24px;padding:12px}.premium-events-mark{width:50px;height:50px;border-radius:17px}.premium-events-top h1{font-size:32px}.clean-events-filters{gap:9px;margin-bottom:12px;border-radius:22px;padding:9px}.clean-events-filter{min-height:42px;padding:0 16px;font-size:14px}.premium-events-count{margin-bottom:14px}.premium-events-list{gap:12px}.premium-event-row{min-height:102px;padding:15px 15px;border-radius:27px;grid-template-columns:1fr}.premium-event-main{grid-template-columns:66px minmax(0,1fr);gap:15px}.premium-event-rank{width:58px;height:58px;border-radius:19px}.premium-event-side{display:none}.premium-event-copy strong{font-size:27px}.premium-event-copy small{font-size:18px}}",
    "@media(max-width:430px){.clean-events-page{padding-left:16px;padding-right:16px}.premium-events-top{gap:12px}.premium-events-mark{width:48px;height:48px}.premium-events-top p{font-size:10px}.premium-events-top h1{font-size:29px}.premium-event-main{grid-template-columns:62px minmax(0,1fr);gap:14px}.premium-event-rank{width:56px;height:56px;border-radius:18px}.premium-event-rank b{font-size:19px}.premium-event-copy strong{font-size:23px}.premium-event-copy small{font-size:16px}.premium-event-row{min-height:98px;border-radius:25px;padding:15px 14px}.clean-events-filter{font-size:14px;padding:0 16px}}",
