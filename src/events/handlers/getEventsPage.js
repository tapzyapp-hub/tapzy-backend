...
function renderCleanStyles() {
  return [
    ...
    ".clean-events-page{position:relative;min-height:100vh;padding:calc(env(safe-area-inset-top,0px) + 14px) 16px calc(116px + env(safe-area-inset-bottom,0px));color:var(--tz-text);background:radial-gradient(circle at 50% 0%,rgba(47,118,255,.28),transparent 38%),linear-gradient(180deg,rgba(7,15,29,.98),rgba(0,0,0,.98) 46%,#000 100%);isolation:isolate;}",
    ".clean-events-page::before{content:\"\";position:fixed;inset:0;z-index:-1;background:radial-gradient(circle at 50% 14%,rgba(47,123,255,.20),transparent 32%),radial-gradient(circle at 16% 22%,rgba(84,161,255,.10),transparent 25%);pointer-events:none;}",
    ".clean-events-page::after{content:\"\";position:fixed;inset:0;z-index:-1;background:linear-gradient(180deg,rgba(255,255,255,.035),transparent 26%),linear-gradient(rgba(255,255,255,.018) 1px,transparent 1px);background-size:100% 100%,100% 46px;opacity:.55;pointer-events:none;}",
