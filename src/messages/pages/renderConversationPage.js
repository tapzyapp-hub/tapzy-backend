...
<style>
  ...
  /* Tapzy Midnight Glass redesign */
  body.tz-has-stories-top-nav.tz-has-stories-bottom-nav .tz-chat-shell{
    padding:10px;
    border-radius:0;
    border:0;
    background:
      radial-gradient(620px 260px at 50% -16%, rgba(49,118,255,.22), transparent 52%),
      radial-gradient(420px 240px at 100% 22%, rgba(255,255,255,.045), transparent 56%),
      linear-gradient(180deg, #02040a 0%, #000 58%, #000 100%);
    box-shadow:none;
  }
  ...
  body.tz-has-stories-top-nav.tz-has-stories-bottom-nav .tz-chat-topbar{
    ...
    border:1px solid rgba(255,255,255,.12);
    background:
      linear-gradient(90deg, rgba(7,10,18,.96), rgba(10,18,34,.88) 45%, rgba(5,7,12,.96)),
      radial-gradient(240px 90px at 18% 0%, rgba(78,153,255,.18), transparent 68%);
    box-shadow:
      inset 0 1px 0 rgba(255,255,255,.06),
      0 18px 46px rgba(0,0,0,.34),
      0 0 24px rgba(47,118,255,.08);
  }
  ...
  body.tz-has-stories-top-nav.tz-has-stories-bottom-nav .tz-chat-pill{
    border-color:rgba(255,255,255,.15);
    background:
      radial-gradient(90px 60px at 50% 0%, rgba(86,154,255,.16), transparent 70%),
      linear-gradient(180deg, rgba(12,17,28,.98), rgba(0,0,0,.96));
    box-shadow:
      inset 0 1px 0 rgba(255,255,255,.06),
  ...
  body.tz-has-stories-top-nav.tz-has-stories-bottom-nav .tz-chat-pill-danger{
    ...
    background:
      radial-gradient(90px 60px at 50% 0%, rgba(255,71,115,.26), transparent 68%),
      linear-gradient(180deg, rgba(45,13,22,.98), rgba(8,0,4,.98));
    box-shadow:
      inset 0 1px 0 rgba(255,255,255,.08),
      0 0 22px rgba(255,48,96,.14),
      0 10px 24px rgba(0,0,0,.28);
  }
  ...
  body.tz-has-stories-top-nav.tz-has-stories-bottom-nav .tz-chat-window{
    ...
    border-radius:30px;
    background:
      radial-gradient(520px 220px at 84% 4%, rgba(45,113,255,.10), transparent 48%),
      radial-gradient(360px 250px at 12% 72%, rgba(255,255,255,.035), transparent 58%),
      linear-gradient(180deg, rgba(1,3,8,.98), rgba(0,0,0,1) 78%);
    box-shadow:
      inset 0 1px 0 rgba(255,255,255,.035),
      inset 0 0 0 1px rgba(47,118,255,.035),
  ...
  body.tz-has-stories-top-nav.tz-has-stories-bottom-nav .tz-chat-bubble.mine{
    color:#fff;
    background:
      radial-gradient(190px 90px at 76% 0%, rgba(255,255,255,.16), transparent 62%),
      linear-gradient(180deg, rgba(20,42,86,.92), rgba(5,10,22,.96));
    border:1px solid rgba(139,197,255,.34);
    box-shadow:
      0 18px 36px rgba(0,0,0,.34),
      0 0 26px rgba(47,118,255,.16),
  ...
  body.tz-has-stories-top-nav.tz-has-stories-bottom-nav .tz-chat-bubble.other{
    color:#fff;
    background:
      radial-gradient(190px 90px at 76% 0%, rgba(255,255,255,.075), transparent 62%),
      linear-gradient(180deg, rgba(18,20,28,.88), rgba(0,0,0,.92));
  ...
  body.tz-has-stories-top-nav.tz-has-stories-bottom-nav .tz-chat-composer-inner{
    ...
    padding:9px;
    background:
      linear-gradient(90deg, rgba(4,7,13,.98), rgba(9,18,36,.92) 50%, rgba(4,7,13,.98)),
      radial-gradient(260px 90px at 50% -20%, rgba(47,118,255,.20), transparent 70%);
    box-shadow:
      inset 0 1px 0 rgba(255,255,255,.06),
      0 -8px 32px rgba(47,118,255,.10),
      0 18px 38px rgba(0,0,0,.36);
  }
  ...
  body.tz-has-stories-top-nav.tz-has-stories-bottom-nav .tz-chat-input-wrap{
    border:1px solid rgba(255,255,255,.13);
    border-radius:24px;
    background:linear-gradient(180deg, rgba(13,15,20,.98), rgba(0,0,0,1));
  ...
  body.tz-has-stories-top-nav.tz-has-stories-bottom-nav .tz-chat-upload-pill{
    ...
    background:
      radial-gradient(80px 50px at 50% 0%, rgba(255,255,255,.18), transparent 70%),
      linear-gradient(145deg,#2f76ff,#1145ad);
    box-shadow:
      0 0 24px rgba(47,118,255,.38),
      inset 0 1px 0 rgba(255,255,255,.18);
  }
  ...
  /* Post-story black base: blue becomes accent only */
  body.tz-has-stories-top-nav.tz-has-stories-bottom-nav .tz-chat-shell{
    background:#000;
    box-shadow:none;
  }
  ...
  body.tz-has-stories-top-nav.tz-has-stories-bottom-nav .tz-chat-shell::before{
    opacity:.28;
    background:radial-gradient(360px 180px at 50% 0%, rgba(47,118,255,.10), transparent 68%);
    filter:blur(8px);
  }
  ...
  body.tz-has-stories-top-nav.tz-has-stories-bottom-nav .tz-chat-composer-inner{
    background:
      radial-gradient(260px 100px at 50% 0%, rgba(255,255,255,.035), transparent 72%),
      linear-gradient(180deg, rgba(5,6,10,.98), rgba(0,0,0,1));
  ...
  body.tz-has-stories-top-nav.tz-has-stories-bottom-nav .tz-chat-window::before{
    background:
      linear-gradient(180deg, rgba(255,255,255,.028), transparent 16%, transparent 86%, rgba(47,118,255,.028)),
      radial-gradient(260px 150px at 80% 0%, rgba(47,118,255,.055), transparent 70%);
  }

  body.tz-has-stories-top-nav.tz-has-stories-bottom-nav .tz-chat-bubble.mine{
    background:
      radial-gradient(160px 78px at 76% 0%, rgba(255,255,255,.10), transparent 64%),
      linear-gradient(180deg, rgba(20,24,34,.96), rgba(4,5,8,.98));
    border-color:rgba(92,170,255,.26);
    box-shadow:
      0 16px 32px rgba(0,0,0,.34),
      0 0 20px rgba(47,118,255,.10),
      inset 0 1px 0 rgba(255,255,255,.08);
  }

  body.tz-has-stories-top-nav.tz-has-stories-bottom-nav .tz-chat-bubble.mine::before{
    background:linear-gradient(135deg, rgba(255,255,255,.10), transparent 38%, rgba(47,118,255,.05));
    opacity:.56;
  }

  body.tz-has-stories-top-nav.tz-has-stories-bottom-nav .tz-chat-bubble.other{
    background:
      radial-gradient(150px 78px at 76% 0%, rgba(255,255,255,.055), transparent 64%),
      linear-gradient(180deg, rgba(12,13,17,.94), rgba(0,0,0,.96));
    border-color:rgba(255,255,255,.13);
  }

  body.tz-has-stories-top-nav.tz-has-stories-bottom-nav .tz-chat-input-wrap{
    background:linear-gradient(180deg, rgba(16,16,18,.98), rgba(0,0,0,1));
    border-color:rgba(255,255,255,.13);
  }

  body.tz-has-stories-top-nav.tz-has-stories-bottom-nav .tz-chat-upload-pill{
    box-shadow:
      0 0 18px rgba(47,118,255,.30),
  ...
  /* Jet black finish: blue is edge glow only */
  body.tz-has-stories-top-nav.tz-has-stories-bottom-nav .wrap,
  body.tz-has-stories-top-nav.tz-has-stories-bottom-nav .tz-chat-shell{
  ...
  body.tz-has-stories-top-nav.tz-has-stories-bottom-nav .tz-chat-shell::before{
    opacity:.30;
    background:
      radial-gradient(360px 150px at 50% 0%, rgba(47,118,255,.16), transparent 70%),
      radial-gradient(220px 90px at 50% 100%, rgba(47,118,255,.10), transparent 72%);
    filter:blur(10px);
  }
  ...
  body.tz-has-stories-top-nav.tz-has-stories-bottom-nav .tz-chat-composer-inner{
    background:
      linear-gradient(180deg, rgba(4,4,6,.98), rgba(0,0,0,1)) !important;
    border-color:rgba(255,255,255,.12);
    box-shadow:
      inset 0 1px 0 rgba(255,255,255,.045),
      0 0 0 1px rgba(47,118,255,.08),
      0 0 26px rgba(47,118,255,.15),
  ...
  body.tz-has-stories-top-nav.tz-has-stories-bottom-nav .tz-chat-window{
    box-shadow:
      inset 0 1px 0 rgba(255,255,255,.035),
      inset 0 0 0 1px rgba(47,118,255,.045),
      0 0 28px rgba(47,118,255,.12),
  ...
  body.tz-has-stories-top-nav.tz-has-stories-bottom-nav .tz-chat-window::before{
    opacity:.82;
    background:
      linear-gradient(180deg, rgba(255,255,255,.022), transparent 18%, transparent 82%, rgba(47,118,255,.026)),
      radial-gradient(280px 120px at 88% 0%, rgba(47,118,255,.08), transparent 70%);
  }
  ...
  body.tz-has-stories-top-nav.tz-has-stories-bottom-nav .tz-chat-date-divider span,
  body.tz-has-stories-top-nav.tz-has-stories-bottom-nav .tz-chat-input-wrap{
    background:linear-gradient(180deg, rgba(10,10,12,.98), rgba(0,0,0,1)) !important;
    border-color:rgba(255,255,255,.14);
    box-shadow:
      inset 0 1px 0 rgba(255,255,255,.055),
      0 0 18px rgba(47,118,255,.12),
  ...
  body.tz-has-stories-top-nav.tz-has-stories-bottom-nav .tz-chat-pill-danger{
    background:linear-gradient(180deg, rgba(48,10,20,.96), rgba(10,0,4,1)) !important;
    border-color:rgba(255,78,120,.28);
    box-shadow:
      inset 0 1px 0 rgba(255,255,255,.06),
      0 0 20px rgba(255,45,90,.16),
      0 10px 24px rgba(0,0,0,.32);
  }
  ...
  body.tz-has-stories-top-nav.tz-has-stories-bottom-nav .tz-chat-bubble.other{
    background:
      radial-gradient(150px 74px at 75% 0%, rgba(255,255,255,.055), transparent 66%),
      linear-gradient(180deg, rgba(9,10,14,.98), rgba(0,0,0,.98)) !important;
    border-color:rgba(105,180,255,.22);
    box-shadow:
      0 14px 30px rgba(0,0,0,.36),
      0 0 20px rgba(47,118,255,.13),
      inset 0 1px 0 rgba(255,255,255,.055);
  }

  body.tz-has-stories-top-nav.tz-has-stories-bottom-nav .tz-chat-bubble.mine::before{
    background:linear-gradient(135deg, rgba(255,255,255,.075), transparent 42%, rgba(47,118,255,.055));
    opacity:.54;
  }
  ...
  body.tz-has-stories-top-nav.tz-has-stories-bottom-nav .tz-chat-mic{
    ...
    border-color:rgba(255,255,255,.72);
    box-shadow:
      0 0 24px rgba(47,118,255,.42),
      inset 0 1px 0 rgba(255,255,255,.18);
  }

  body.tz-has-stories-top-nav.tz-has-stories-bottom-nav .tz-chat-send{
    background:linear-gradient(180deg,#ffffff,#dceeff) !important;
    color:#05070d;
    border-color:rgba(255,255,255,.82);
    box-shadow:
      0 0 18px rgba(255,255,255,.18),
      0 0 22px rgba(47,118,255,.16),
      0 12px 26px rgba(0,0,0,.30);
  }

  /* Reference card pass: black Tapzy card with blue edge glow */
  body.tz-has-stories-top-nav.tz-has-stories-bottom-nav > .wrap{
    background:#000 !important;
  ...
  body.tz-has-stories-top-nav.tz-has-stories-bottom-nav .tz-chat-shell{
    ...
    border:1px solid rgba(255,255,255,.13);
    background:
      radial-gradient(360px 160px at 72% 10%, rgba(47,118,255,.08), transparent 68%),
      linear-gradient(180deg, #050609 0%, #000 72%) !important;
    box-shadow:
      inset 0 1px 0 rgba(255,255,255,.055) !important,
      inset 0 0 0 1px rgba(47,118,255,.07) !important,
      0 0 0 1px rgba(0,0,0,.86) !important,
      0 0 28px rgba(47,118,255,.16) !important,
      0 18px 44px rgba(0,0,0,.54) !important;
  }

  body.tz-has-stories-top-nav.tz-has-stories-bottom-nav .tz-chat-shell::before{
    opacity:.18;
    background:radial-gradient(320px 130px at 50% 0%, rgba(47,118,255,.14), transparent 72%);
    filter:blur(14px);
  }
  ...
  body.tz-has-stories-top-nav.tz-has-stories-bottom-nav .tz-chat-topbar{
    ...
    border:1px solid rgba(255,255,255,.10);
    background:
      radial-gradient(280px 120px at 70% 0%, rgba(47,118,255,.085), transparent 68%),
      linear-gradient(180deg, rgba(7,8,12,.96), rgba(0,0,0,.98)) !important;
    box-shadow:
      inset 0 1px 0 rgba(255,255,255,.045),
      0 0 0 1px rgba(47,118,255,.055),
      0 0 22px rgba(47,118,255,.10),
  ...
  body.tz-has-stories-top-nav.tz-has-stories-bottom-nav .tz-chat-partner-avatar{
    ...
    border-radius:15px;
    background:
      radial-gradient(70px 46px at 50% 0%, rgba(255,255,255,.045), transparent 70%),
      linear-gradient(180deg, rgba(11,12,16,.98), #000) !important;
    border-color:rgba(255,255,255,.13);
    box-shadow:
      inset 0 1px 0 rgba(255,255,255,.055),
      0 0 16px rgba(47,118,255,.11),
  ...
  body.tz-has-stories-top-nav.tz-has-stories-bottom-nav .tz-chat-partner-badge{
    ...
    letter-spacing:.07em;
    text-transform:uppercase;
    background:linear-gradient(180deg, rgba(22,24,32,.98), rgba(5,6,10,.98)) !important;
    border-color:rgba(255,255,255,.12);
    color:rgba(255,255,255,.82);
    box-shadow:0 0 14px rgba(47,118,255,.08);
  }

  body.tz-has-stories-top-nav.tz-has-stories-bottom-nav .tz-chat-partner-handle{
    display:block;
    margin-top:3px;
    font-size:12px;
  ...
  body.tz-has-stories-top-nav.tz-has-stories-bottom-nav .tz-chat-open-profile{
    display:inline-flex;
    align-items:center;
    justify-content:center;
    margin-top:12px;
    ...
    font-size:13px;
    font-weight:850;
    background:linear-gradient(180deg, rgba(13,14,18,.98), #000) !important;
    border:1px solid rgba(255,255,255,.13);
    box-shadow:
      inset 0 1px 0 rgba(255,255,255,.055),
  ...
  body.tz-has-stories-top-nav.tz-has-stories-bottom-nav .tz-chat-pill{
    ...
    min-height:38px;
    border-radius:17px;
    background:linear-gradient(180deg, rgba(12,14,20,.98), #000) !important;
    border-color:rgba(255,255,255,.13);
  }
  ...
  body.tz-has-stories-top-nav.tz-has-stories-bottom-nav .tz-chat-window{
    ...
    border:1px solid rgba(255,255,255,.10);
    background:
      radial-gradient(320px 170px at 82% 0%, rgba(47,118,255,.065), transparent 70%),
      linear-gradient(180deg, #030407 0%, #000 76%) !important;
    box-shadow:
      inset 0 1px 0 rgba(255,255,255,.035),
      inset 0 0 0 1px rgba(47,118,255,.04),
      0 0 22px rgba(47,118,255,.10),
      0 16px 34px rgba(0,0,0,.34);
  }
  ...
  body.tz-has-stories-top-nav.tz-has-stories-bottom-nav .tz-chat-bubble.other{
    border-radius:22px;
    background:
      radial-gradient(150px 70px at 78% 0%, rgba(47,118,255,.075), transparent 68%),
      linear-gradient(180deg, rgba(8,9,13,.98), rgba(0,0,0,.99)) !important;
    border-color:rgba(85,156,255,.20);
    box-shadow:
  ...
  body.tz-has-stories-top-nav.tz-has-stories-bottom-nav .tz-chat-bubble.has-image,
  ...
  body.tz-has-stories-top-nav.tz-has-stories-bottom-nav .tz-chat-composer-inner{
    ...
    border:1px solid rgba(255,255,255,.12);
    background:
      radial-gradient(260px 100px at 76% 0%, rgba(47,118,255,.08), transparent 70%),
      linear-gradient(180deg, rgba(7,8,11,.98), #000) !important;
    box-shadow:
      inset 0 1px 0 rgba(255,255,255,.05),
      0 0 0 1px rgba(47,118,255,.055),
      0 0 24px rgba(47,118,255,.14),
      0 14px 30px rgba(0,0,0,.38);
  }

  body.tz-has-stories-top-nav.tz-has-stories-bottom-nav .tz-chat-input-wrap{
    border-radius:18px;
    background:linear-gradient(180deg, rgba(20,20,23,.98), rgba(5,5,7,.98)) !important;
    border-color:rgba(255,255,255,.12);
  }
  ...
  body.tz-has-stories-top-nav.tz-has-stories-bottom-nav .tz-chat-mic{
    ...
    border-radius:50%;
    background:
      radial-gradient(80px 48px at 50% 0%, rgba(255,255,255,.10), transparent 70%),
      linear-gradient(180deg, rgba(16,18,24,.98), #000) !important;
    border-color:rgba(255,255,255,.14);
    color:#fff;
    box-shadow:
      inset 0 1px 0 rgba(255,255,255,.06),
      0 0 16px rgba(47,118,255,.12),
      0 10px 22px rgba(0,0,0,.30);
  }
  ...
  body.tz-has-stories-top-nav.tz-has-stories-bottom-nav .tz-chat-send{
    ...
    color:#fff;
    background:
      radial-gradient(110px 60px at 50% 0%, rgba(47,118,255,.16), transparent 70%),
      linear-gradient(180deg, rgba(13,15,22,.98), #000) !important;
    border-color:rgba(255,255,255,.16);
    box-shadow:
      inset 0 1px 0 rgba(255,255,255,.06),
      0 0 18px rgba(47,118,255,.14),
  ...
  /* Restore image-2 style: integrated app page, not a standalone card */
  body.tz-has-stories-top-nav.tz-has-stories-bottom-nav > .wrap{
    background:#000 !important;
    padding:0 !important;
  }
  ...
  body.tz-has-stories-top-nav.tz-has-stories-bottom-nav .tz-chat-shell::before{
    opacity:.18;
    background:radial-gradient(360px 150px at 50% 0%, rgba(47,118,255,.10), transparent 72%);
    filter:blur(12px);
  }
  ...
  body.tz-has-stories-top-nav.tz-has-stories-bottom-nav .tz-chat-topbar{
    ...
    border:1px solid rgba(255,255,255,.12);
    background:
      radial-gradient(260px 95px at 18% 0%, rgba(47,118,255,.10), transparent 68%),
  ...
  body.tz-has-stories-top-nav.tz-has-stories-bottom-nav .tz-chat-partner-avatar{
    ...
    border-radius:18px;
    background:
      radial-gradient(80px 52px at 50% 0%, rgba(47,118,255,.10), transparent 70%),
  ...
  body.tz-has-stories-top-nav.tz-has-stories-bottom-nav .tz-chat-partner-badge{
    ...
    padding:0 8px;
    font-size:10px;
    background:linear-gradient(180deg, rgba(12,14,20,.98), rgba(0,0,0,1)) !important;
    border-color:rgba(255,255,255,.12);
  }
  ...
  body.tz-has-stories-top-nav.tz-has-stories-bottom-nav .tz-chat-pill-danger{
    ...
    color:#fff;
    background:
      radial-gradient(120px 66px at 50% 0%, rgba(47,118,255,.12), transparent 70%),
