  ...
  try {
    ...
    <style>
      ...
      .profile-showcase{
        ...
        background:
          radial-gradient(900px 420px at 50% 0%, rgba(255,255,255,.03), transparent 42%),
      ...
      .profile-showcase-glow-a{
        ...
        right:-30px;
        top:-36px;
        background:radial-gradient(circle, rgba(255,255,255,.035) 0%, rgba(255,255,255,.01) 38%, transparent 72%);
      }
      ...
      .profile-showcase-glow-b{
        ...
        left:70px;
        bottom:-48px;
        background:radial-gradient(circle, rgba(255,255,255,.025) 0%, rgba(255,255,255,.008) 40%, transparent 75%);
      }
      ...
      .profile-stat-chip{
        ...
        border:1px solid rgba(255,255,255,.06);
        background:
          radial-gradient(220px 140px at 50% 0%, rgba(255,255,255,.035), transparent 60%),
          linear-gradient(180deg, rgba(0,0,0,.98), rgba(0,0,0,1));
        box-shadow:
          inset 0 1px 0 rgba(255,255,255,.03),
      ...
      .profile-stat-chip::after{
        ...
        width:72px;
        height:36px;
        background:radial-gradient(circle, rgba(255,255,255,.08) 0%, rgba(255,255,255,.02) 40%, transparent 75%);
        filter:blur(8px);
        pointer-events:none;
      }
      ...
      .profile-preview-panel{
        ...
        overflow:hidden;
        background:
          radial-gradient(520px 220px at 70% 18%, rgba(255,255,255,.04), transparent 42%),
          linear-gradient(180deg, rgba(0,0,0,.98), rgba(0,0,0,1));
        border:1px solid rgba(255,255,255,.06);
        box-shadow:
          inset 0 1px 0 rgba(255,255,255,.03),
      ...
      .profile-preview-panel::before{
        ...
        height:70px;
        border-radius:999px;
        background:radial-gradient(circle, rgba(255,255,255,.07) 0%, rgba(255,255,255,.02) 45%, transparent 75%);
        filter:blur(10px);
        pointer-events:none;
      }
      ...
      .profile-simple-link{
        ...
        border-radius:22px;
        background:
          radial-gradient(420px 180px at 68% 20%, rgba(255,255,255,.04), transparent 42%),
          linear-gradient(180deg, rgba(0,0,0,.98), rgba(0,0,0,1));
        border:1px solid rgba(255,255,255,.06);
        box-shadow:
          inset 0 1px 0 rgba(255,255,255,.03),
      ...
      .profile-simple-link::before{
        ...
        bottom:-24px;
        border-radius:999px;
        background:radial-gradient(circle, rgba(255,255,255,.06) 0%, rgba(255,255,255,.02) 42%, transparent 74%);
        filter:blur(8px);
        pointer-events:none;
      }
