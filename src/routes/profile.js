...
router.get("/qr/:username", async (req, res) => {
  ...
  try {
    ...
    <style>
      ...
      /* QR reference casing tune */
      .tz-qr-card{
        padding: 30px 12px 34px !important;
        align-items: center !important;
        background:
          radial-gradient(ellipse at 50% 24%, rgba(148, 225, 255, .20), transparent 38%),
          linear-gradient(112deg, rgba(114, 209, 255, .12) 0 1px, transparent 1px 43%),
          linear-gradient(248deg, rgba(114, 209, 255, .10) 0 1px, transparent 1px 42%),
          linear-gradient(180deg, rgba(9, 21, 34, .94), rgba(0,0,0,.99)) !important;
      }
      ...
      .tz-qr-frame{
        ...
        border-radius: 42px !important;
        background:
          linear-gradient(135deg, #b4f3ff 0%, #75d8ff 20%, #3e86ff 52%, #b2f5ff 100%) !important;
        box-shadow:
          0 0 0 1px rgba(250,254,255,.72) inset,
          0 0 30px rgba(129,225,255,.62),
          0 0 86px rgba(50,133,255,.40),
          0 28px 60px rgba(0,0,0,.60) !important;
      }

      .tz-qr-frame::before{
        inset: -72px -58px -56px !important;
        border-radius: 64px !important;
        background:
          linear-gradient(180deg, rgba(255,255,255,.24), rgba(255,255,255,.055) 38%, rgba(99,201,255,.035) 100%),
          linear-gradient(rgba(136,216,255,.12) 1px, transparent 1px),
          linear-gradient(90deg, rgba(136,216,255,.09) 1px, transparent 1px),
          radial-gradient(ellipse at 50% 0%, rgba(218,250,255,.30), transparent 32%),
          radial-gradient(ellipse at 50% 52%, transparent 54%, rgba(156,231,255,.27) 67%, transparent 77%) !important;
        background-size: 100% 100%, 100% 34px, 44px 100%, 100% 100%, 100% 100% !important;
        border: 1px solid rgba(218, 249, 255, .20) !important;
        box-shadow:
          inset 0 0 0 1px rgba(255,255,255,.10),
          inset 0 0 64px rgba(133,222,255,.14),
          0 0 36px rgba(82,187,255,.18) !important;
        opacity: .88 !important;
      }

      .tz-qr-frame::after{
        inset: -34px -29px -34px !important;
        border-radius: 52px !important;
        background:
          linear-gradient(180deg, rgba(255,255,255,.22), rgba(255,255,255,.045) 34%, transparent 72%),
          radial-gradient(ellipse at 42% 3%, rgba(255,255,255,.34), transparent 17%),
          radial-gradient(ellipse at 50% 50%, transparent 56%, rgba(163,235,255,.22) 69%, transparent 75%) !important;
        border: 1px solid rgba(225, 250, 255, .20) !important;
        opacity: .92 !important;
      }
      ...
      .tz-qr-frame-inner{
        ...
        background:
          radial-gradient(circle at 50% 0%, rgba(235,252,255,.95), #fff 46%, #f7fdff 100%) !important;
        box-shadow:
          0 0 0 5px rgba(255,255,255,.78),
          inset 0 0 0 1px rgba(0,0,0,.04),
          inset 0 0 30px rgba(110,198,255,.10) !important;
      }

      .tz-qr-frame-inner::after{
        inset: -8px !important;
        border-radius: 38px !important;
        border: 2px solid rgba(210, 248, 255, .68) !important;
        box-shadow:
          inset 0 0 20px rgba(120, 218, 255, .18),
          0 0 24px rgba(82, 188, 255, .24) !important;
      }
      ...
      @media(max-width:700px){
        ...
        .tz-qr-frame::before{
          inset: -62px -42px -50px !important;
          border-radius: 56px !important;
        }
        .tz-qr-frame::after{
          inset: -30px -22px -30px !important;
          border-radius: 46px !important;
        }
        .tz-qr-frame-inner{
