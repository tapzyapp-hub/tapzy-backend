  ...
  <style>
    ...
    *{box-sizing:border-box}
    ...
    body{background:
      ...
      #000}
    .tapzy-ai-shell{width:min(100%,620px);min-height:100dvh;margin:0 auto;padding:calc(18px + env(safe-area-inset-top)) 18px calc(24px + env(safe-area-inset-bottom));display:flex;flex-direction:column;gap:16px}
    .tapzy-ai-top{display:flex;align-items:center;justify-content:space-between;padding:10px 0 14px;border-bottom:1px solid rgba(255,255,255,.08)}
    ...
    .tapzy-ai-orb{position:relative;min-height:390px;border:1px solid var(--line);border-radius:32px;background:radial-gradient(circle at 50% 38%,rgba(47,123,255,.34),transparent 38%),linear-gradient(180deg,rgba(11,25,45,.88),rgba(2,6,13,.92));box-shadow:0 24px 80px rgba(0,0,0,.64),0 0 45px rgba(47,123,255,.18);overflow:hidden;display:grid;place-items:center}
    ...
    .tapzy-ai-face{position:relative;z-index:1;width:min(56%,250px);aspect-ratio:1;border-radius:999px;object-fit:cover;box-shadow:0 0 0 10px rgba(20,43,78,.72),0 0 70px rgba(47,123,255,.52)}
    .tapzy-ai-state{position:absolute;left:28px;bottom:28px;z-index:2;display:flex;align-items:center;gap:10px;border:1px solid rgba(255,255,255,.13);border-radius:999px;background:rgba(0,0,0,.48);padding:13px 18px;font-weight:900;font-size:18px;box-shadow:0 12px 34px rgba(0,0,0,.32)}
    .tapzy-ai-dot{width:11px;height:11px;border-radius:50%;background:#3fa2ff;box-shadow:0 0 18px rgba(63,162,255,.9)}
    .tapzy-ai-messages{display:flex;flex-direction:column;gap:12px;min-height:120px;max-height:34dvh;overflow:auto;padding:2px;scrollbar-width:none}
    .tapzy-ai-messages::-webkit-scrollbar{display:none}
    .tapzy-ai-bubble{max-width:88%;padding:15px 17px;border-radius:22px;font-size:17px;line-height:1.42;overflow-wrap:anywhere;box-shadow:0 18px 45px rgba(0,0,0,.24)}
    ...
    .tapzy-ai-chips{display:flex;gap:12px;overflow-x:auto;scrollbar-width:none}
    .tapzy-ai-chips::-webkit-scrollbar{display:none}
    .tapzy-ai-chip{flex:0 0 auto;border:1px solid rgba(125,194,255,.3);border-radius:999px;background:rgba(7,13,25,.76);color:#fff;padding:12px 18px;font-size:13px;font-weight:950;letter-spacing:.12em;text-transform:uppercase}
    .tapzy-ai-composer{display:grid;grid-template-columns:88px 1fr 88px;gap:12px;border:1px solid rgba(125,194,255,.22);border-radius:28px;background:rgba(8,14,27,.86);padding:12px;box-shadow:0 18px 56px rgba(0,0,0,.44)}
    .tapzy-ai-button,.tapzy-ai-input{height:64px;border-radius:22px;border:1px solid rgba(255,255,255,.1);font:900 20px/1 Inter,system-ui,sans-serif;color:#fff}
    ...
    .tapzy-ai-input{min-width:0;background:rgba(255,255,255,.07);padding:0 18px;outline:none}
    .tapzy-ai-input::placeholder{color:rgba(255,255,255,.48)}
    .tapzy-ai-brain{display:grid;grid-template-columns:56px 1fr auto;gap:14px;align-items:center;border:1px solid rgba(125,194,255,.22);border-radius:22px;background:rgba(5,15,31,.84);padding:14px 16px}
    .tapzy-ai-brain-icon{width:48px;height:48px;border-radius:16px;border:1px solid rgba(125,194,255,.24);display:grid;place-items:center;background:radial-gradient(circle,rgba(55,158,255,.26),rgba(255,255,255,.04))}
    .tapzy-ai-brain-title{font-size:17px;font-weight:950;margin-bottom:7px}
    .tapzy-ai-bar{height:10px;border-radius:999px;background:rgba(255,255,255,.11);overflow:hidden}
    ...
    @media(max-width:520px){.tapzy-ai-shell{padding-left:14px;padding-right:14px}.tapzy-ai-orb{min-height:370px;border-radius:28px}.tapzy-ai-composer{grid-template-columns:74px 1fr 74px}.tapzy-ai-button,.tapzy-ai-input{height:58px;border-radius:20px;font-size:18px}.tapzy-ai-bubble{font-size:16px}.tapzy-ai-title{font-size:22px}}
  </style>
</head>
<body>
  <main class="tapzy-ai-shell" data-tapzy-ai-room>
    ...
    <form class="tapzy-ai-composer" data-composer autocomplete="off">
      ...
      <input class="tapzy-ai-input" data-input placeholder="Ask Tapzy anything..." />
  ...
  <script>
    (function(){
      ...
      var memory=[];
      var geo=null;
      function setState(text){state.textContent=text||'Idle'}
