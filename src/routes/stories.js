    ...
    <head>
      ...
      <style>
        ...
        *{box-sizing:border-box}
        ...
        .sf-empty a::after{content:"";position:absolute;left:24%;right:24%;bottom:-9px;height:14px;border-radius:999px;background:rgba(125,178,255,.55);filter:blur(16px);pointer-events:none}
