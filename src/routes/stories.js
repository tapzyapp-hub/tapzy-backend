    ...
    <head>
      ...
      <style>
        ...
        *{box-sizing:border-box}
        ...
        .sf-actions{position:absolute;z-index:5;right:9px;bottom:calc(var(--safe-bottom) + 78px);display:flex;flex-direction:column;align-items:center;gap:10px;width:58px;padding:8px 3px;border-radius:29px;background:linear-gradient(180deg,rgba(238,248,255,.16),rgba(8,15,26,.20) 42%,rgba(3,7,14,.28));border:1px solid rgba(218,241,255,.16);box-shadow:inset 0 1px 0 rgba(255,255,255,.22),inset 0 -1px 0 rgba(115,190,255,.08),0 12px 34px rgba(0,0,0,.18),0 0 22px rgba(92,178,255,.08);backdrop-filter:blur(18px) saturate(1.22);-webkit-backdrop-filter:blur(18px) saturate(1.22)}
        .sf-actions.is-idle{opacity:.24;background:linear-gradient(180deg,rgba(238,248,255,.10),rgba(6,12,22,.14) 46%,rgba(0,0,0,.20));border-color:rgba(218,241,255,.10);backdrop-filter:blur(14px) saturate(1.08);-webkit-backdrop-filter:blur(14px) saturate(1.08);transition:opacity .28s ease,background .28s ease,backdrop-filter .28s ease,border-color .28s ease}
